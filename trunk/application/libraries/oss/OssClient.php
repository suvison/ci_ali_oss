<?php
require_once 'Model/XmlConfig.php';
require_once 'Result/Result.php';


require_once 'Core/MimeTypes.php';
require_once 'Core/OssException.php';
require_once 'Http/RequestCore.php';
require_once 'Http/RequestCore_Exception.php';
require_once 'Http/ResponseCore.php';
require_once 'Model/CorsConfig.php';
require_once 'Model/CnameConfig.php';
require_once 'Model/LoggingConfig.php';
require_once 'Model/LiveChannelConfig.php';
require_once 'Model/LiveChannelInfo.php';
require_once 'Model/LiveChannelListInfo.php';
require_once 'Result/AclResult.php';
require_once 'Result/BodyResult.php';
require_once 'Result/GetCorsResult.php';
require_once 'Result/GetLifecycleResult.php';
require_once 'Result/GetLoggingResult.php';
require_once 'Result/GetRefererResult.php';
require_once 'Result/GetWebsiteResult.php';
require_once 'Result/GetCnameResult.php';
require_once 'Result/HeaderResult.php';
require_once 'Result/InitiateMultipartUploadResult.php';
require_once 'Result/ListBucketsResult.php';
require_once 'Result/ListMultipartUploadResult.php';
require_once 'Model/ListMultipartUploadInfo.php';
require_once 'Result/ListObjectsResult.php';
require_once 'Result/ListPartsResult.php';
require_once 'Result/PutSetDeleteResult.php';
require_once 'Result/DeleteObjectsResult.php';
require_once 'Result/CopyObjectResult.php';
require_once 'Result/CallbackResult.php';
require_once 'Result/ExistResult.php';
require_once 'Result/PutLiveChannelResult.php';
require_once 'Result/GetLiveChannelHistoryResult.php';
require_once 'Result/GetLiveChannelInfoResult.php';
require_once 'Result/GetLiveChannelStatusResult.php';
require_once 'Result/ListLiveChannelResult.php';
require_once 'Result/AppendResult.php';
require_once 'Model/ObjectListInfo.php';
require_once 'Result/UploadPartResult.php';
require_once 'Model/BucketListInfo.php';
require_once 'Model/LifecycleConfig.php';
require_once 'Model/RefererConfig.php';
require_once 'Model/WebsiteConfig.php';
require_once 'Core/OssUtil.php';
require_once 'Model/ListPartsInfo.php';

require_once 'Model/ObjectInfo.php';
require_once 'Model/PrefixInfo.php';
...
class OssClient
{
    ...
    // public function __construct()
    {
        ...
        // $accessKeyId = trim(OSS_ACCESS_ID);
        // $accessKeySecret = trim(OSS_ACCESS_SECRET);
        // $endpoint = trim(trim(ENDPOINT), "/");
        // $isCName = ISCNAME;
